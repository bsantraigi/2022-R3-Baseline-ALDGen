...
class disc_config(object):
    ...
    #hidden_neural_size = 128
    num_layers = 2
    train_dir = './dd/disc_data/'
    name_model = "disc_model_dd"
    tensorboard_dir = "./tensorboard/dd_disc_log/"
    name_loss = "disc_loss"
    max_len = 50
    piece_size = batch_size * steps_per_checkpoint
    piece_dir = "./dd/disc_data/batch_piece/"
    #query_len = 0
    valid_num = 100
    init_scale = 0.1
    num_class = 2
...
class gen_config(object):
    ...
    num_layers = 2
    vocab_size = 25000
    train_dir = "./dd/gen_data/"
    name_model = "st_model"
    tensorboard_dir = "./tensorboard/dd_gen_log/"
    name_loss = "gen_loss"
...
class GSTConfig(object):
    ...
    num_layers = 2
    vocab_size = 25000
    train_dir = "./gst_data/dd/"
    name_model = "st_model_dd"
    tensorboard_dir = "./tensorboard/dd_gst_log/"
    name_loss = "gst_loss"
    max_train_data_size = 0
    steps_per_checkpoint = 200
    buckets =        [(5, 10), (10, 15), (20, 25), (40, 50)]
